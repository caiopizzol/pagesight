...
export function registerObserveTool(server: McpServer): void {
  server.tool(
    "observe",
    "Run the shared Pagesight API. Read-only operations: discover; gsc.sites/sitemaps/inspect/report; ga.accounts/property/key-events/report; page; speed.psi/crux/history; doctor; snapshot. Pass the API operation object as request. Returns structured evidence, exact effective requests, provider responses and partial errors. See the CLI --help and README for report/config shapes.",
